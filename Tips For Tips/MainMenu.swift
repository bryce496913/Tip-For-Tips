...
struct ReceiptDetailView: View {
    ...
    var body: some View {
        ...
        }.padding(AppSpacing.screen) } }.navigationTitle("Receipt").task(id: reloadToken) { await reload() }.onAppear { reloadToken = UUID() }
    }
...
struct DataManagementView: View {
    ...
    private func runDeletion(_ deletion: PendingDeletion) async {
        ...
        if deletion.refreshEnvironmentOnSuccess, (r.completedFully || r.requiresEnvironmentRefresh) { await appEnvironment.resetAfterDataDeletion() }
